        ...
        <>
            <div>
                <div className='flex flex-col gap-7 lg:gap-10 mt-[70px] lg:mt-[120px] mt-[40px] mx-[20px]  lg:ml-[119px]'>
                    <p className='text-[14px] md:text-[1.5rem] lg:text-[2rem] underline decoration-[#FDC000] underline-offset-8 fontMon font-semibold text-[#333333]'>Reliable Dewatering System</p>
                    <div className='flex flex-col gap-2 lg:gap-4'>
                        <p className='lg:text-[4rem] md:text-[2.5rem] text-[1.4rem] text-[#333333] fontMon font-bold'> <span className='text-[#FDC000]'>Dewatering & Groundwater </span> <br /> Control Services</p>
                        <p className='popins text-[14px] md:text-[18px] lg:text-[20px] text-[#333333]'>Dewatering involves controlled removal of groundwater to maintain dry and safe <br /> excavation sites, protecting foundations and ensuring smooth construction operations.</p>
                    </div>
                </div>
